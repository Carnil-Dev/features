...
function ComplianceDashboard({ className }) {
  ...
  if (loading) {
    return /* @__PURE__ */ React.createElement("div", { className: `flex items-center justify-center h-96 ${className}` }, /* @__PURE__ */ React.createElement("div", { className: "text-center" }, /* @__PURE__ */ React.createElement(lucideReact.RefreshCw, { className: "w-8 h-8 animate-spin mx-auto mb-4 text-blue-600" }), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600" }, "Loading compliance data...")));
  }
  if (error) {
    return /* @__PURE__ */ React.createElement("div", { className: `flex items-center justify-center h-96 ${className}` }, /* @__PURE__ */ React.createElement("div", { className: "text-center" }, /* @__PURE__ */ React.createElement(lucideReact.XCircle, { className: "w-8 h-8 mx-auto mb-4 text-red-600" }), /* @__PURE__ */ React.createElement("p", { className: "text-red-600 mb-4" }, "Error: ", error), /* @__PURE__ */ React.createElement(
      "button",
      {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: `compliance-dashboard ${className}` }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-6" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { className: "text-2xl font-bold text-gray-900" }, "Compliance Dashboard"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600" }, "Monitor and manage compliance across all regulations")), /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-2" }, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(lucideReact.RefreshCw, { className: "w-5 h-5" })
    ...
    /* @__PURE__ */ React.createElement(lucideReact.Download, { className: "w-5 h-5" })
  ), /* @__PURE__ */ React.createElement(
    "button",
    {
      className: "p-2 text-gray-600 hover:text-gray-800 rounded-md hover:bg-gray-100",
    ...
    /* @__PURE__ */ React.createElement(lucideReact.Settings, { className: "w-5 h-5" })
...
function OverviewTab({ data }) {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-3xl font-bold text-blue-600" }, data.overallScore, "%"), /* @__PURE__ */ React.createElement("div", { className: "text-sm text-gray-600" }, "Overall Score")), /* @__PURE__ */ React.createElement("div", { className: "text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-3xl font-bold text-green-600" }, data.passed), /* @__PURE__ */ React.createElement("div", { className: "text-sm text-gray-600" }, "Passed Checks")), /* @__PURE__ */ React.createElement("div", { className: "text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-3xl font-bold text-red-600" }, data.failed), /* @__PURE__ */ React.createElement("div", { className: "text-sm text-gray-600" }, "Failed Checks")))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white p-4 rounded-lg shadow" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-2xl font-bold text-green-600" }, data.passed), /* @__PURE__ */ React.createElement("div", { className: "text-sm text-gray-600" }, "Passed")), /* @__PURE__ */ React.createElement(lucideReact.CheckCircle, { className: "w-8 h-8 text-green-600" }))), /* @__PURE__ */ React.createElement("div", { className: "bg-white p-4 rounded-lg shadow" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-2xl font-bold text-red-600" }, data.failed), /* @__PURE__ */ React.createElement("div", { className: "text-sm text-gray-600" }, "Failed")), /* @__PURE__ */ React.createElement(lucideReact.XCircle, { className: "w-8 h-8 text-red-600" }))), /* @__PURE__ */ React.createElement("div", { className: "bg-white p-4 rounded-lg shadow" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-2xl font-bold text-yellow-600" }, data.warnings), /* @__PURE__ */ React.createElement("div", { className: "text-sm text-gray-600" }, "Warnings")), /* @__PURE__ */ React.createElement(lucideReact.AlertTriangle, { className: "w-8 h-8 text-yellow-600" }))), /* @__PURE__ */ React.createElement("div", { className: "bg-white p-4 rounded-lg shadow" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-2xl font-bold text-gray-600" }, data.totalChecks), /* @__PURE__ */ React.createElement("div", { className: "text-sm text-gray-600" }, "Total Checks")), /* @__PURE__ */ React.createElement(lucideReact.Info, { className: "w-8 h-8 text-gray-600" })))));
}
